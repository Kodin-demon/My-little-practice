...
class Weather_App(QWidget):
    def __init__(self):
        ...
        self.setGeometry(800,300,450,600)
    ...
    def get_weather(self):
        ...
        api_key = # go to https://openweathermap.org login and you could get your own API for free
    ...
    def display_weather(self, data):
        ...
        self.temperature_label.setText(f"{temperature_celsius:.0f}°C / {temperature_fahrenheit:.0f}°F")
